...
<head>
    ...
    <link href="{{URL::asset('theme/admin/assets/stylesheets/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{URL::asset('theme/admin/assets/stylesheets/landerapp.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{URL::asset('theme/admin/assets/stylesheets/widgets.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{URL::asset('theme/admin/assets/stylesheets/pages.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{URL::asset('theme/admin/assets/stylesheets/rtl.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{URL::asset('theme/admin/assets/stylesheets/themes.min.css')}}" rel="stylesheet" type="text/css">

    <!--[if lt IE 9]>
    <script src="{{URL::asset('theme/admin/assets/javascripts/ie.min.js')}}"></script>
    <![endif]-->
...
<!-- Demo script --> <script src="{{URL::asset('theme/admin/assets/demo/demo.js')}}"></script> <!-- / Demo script -->
                        ...
                        <ul class="nav navbar-nav pull-right right-navbar-nav">
                            ...
                            <li class="nav-icon-btn nav-icon-btn-success dropdown">
                                ...
                                <div class="dropdown-menu widget-messages-alt no-padding" style="width: 300px;">
                                    <div class="messages-list" id="main-navbar-messages">
                                        ...
                                        <div class="message">
                                            <img src="{{URL::asset('theme/admin/assets/demo/avatars/2.jpg')}}" alt="" class="message-avatar">
                                        ...
                                        <div class="message">
                                            <img src="{{URL::asset('theme/admin/assets/demo/avatars/3.jpg')}}" alt="" class="message-avatar">
                                        ...
                                        <div class="message">
                                            <img src="{{URL::asset('theme/admin/assets/demo/avatars/4.jpg')}}" alt="" class="message-avatar">
                                        ...
                                        <div class="message">
                                            <img src="{{URL::asset('theme/admin/assets/demo/avatars/5.jpg')}}" alt="" class="message-avatar">
                                            <a href="#" class="message-subject">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</a>
                                            <div class="message-description">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle user-menu" data-toggle="dropdown">
                                    <img src="{{URL::asset('theme/admin/assets/demo/avatars/1.jpg')}}" alt="">
                                    <span>John Doe</span>
                                </a>
                                <ul class="dropdown-menu">
        ...
        <div id="main-menu-inner">
            <div class="menu-content top" id="menu-content-demo">
                ...
                <div>
                    ...
                    <img src="{{URL::asset('theme/admin/assets/demo/avatars/1.jpg')}}" alt="" class="">
                    <div class="btn-group">
...
<!--[if !IE]> -->
<script type="text/javascript"> window.jQuery || document.write('<script src="{{URL::asset('theme/admin/assets/javascripts/jquery.min.js')}}">'+"<"+"/script>"); </script>
<!-- <![endif]-->
<!--[if lte IE 9]>
...
<script src="{{URL::asset('theme/admin/assets/javascripts/bootstrap.min.js')}}"></script>
<script src="{{URL::asset('theme/admin/assets/javascripts/landerapp.min.js')}}"></script>
